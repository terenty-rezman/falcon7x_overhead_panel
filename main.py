...
url = QUrl("components/communication_mkb.qml")
communication_mkb = QQuickView()
communication_mkb.setSource(url)
communication_mkb.setTitle("audio + mkb - falcon7x")
communication_mkb.setWidth(382)
communication_mkb.setHeight(572)
communication_mkb.show()
communication_mkb.setMaximumWidth(382)
communication_mkb.setMaximumHeight(572)

view_helper.all_views.append(overhead_panel)
view_helper.all_views.append(front_panel)
view_helper.all_views.append(communication_mkb)

backend = Backend()
overhead_panel.rootContext().setContextProperty("backend", backend)
front_panel.rootContext().setContextProperty("backend", backend)
communication_mkb.rootContext().setContextProperty("backend", backend)
